...
df = pd.read_csv("Azure_Demand_Forecasting_Data.csv")  # Load dataset into a DataFrame
...
#    (Past usage influences future usage)
# -----------------------------
...
#    (Captures trends & smooth patterns)
# -----------------------------
...
#    (Identifies sudden unexpected demand)
# -----------------------------
...
#    (Lag & rolling windows create nulls)
# -----------------------------
